...
import com.example.cryptomonitoringapp.crypto.presentation.coin_detail.components.InfoCard
...
import com.example.cryptomonitoringapp.presentation.models.toDisplayableNumber
...
fun CoinDetailScreen(
    ...
    if(state.isLoading){
        ...
        Column(
            ...
            Icon(imageVector = ImageVector.vectorResource(id =coin.iconRes),
                ...
                )
            {
                ...
                InfoCard(title = stringResource(id = R.string.change_last_24h),
